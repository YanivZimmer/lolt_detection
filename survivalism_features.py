...
class SurvivalismFeatureExtractor:
    ...
    NATIVE_BINARIES = {
        ...
        'reg.exe', 'sc.exe', 'net.exe', 'nltest.exe', 'takeown.exe', 'icacls.exe',
        'certutil.exe', 'bitsadmin.exe', 'wevtutil.exe', 'schtasks.exe', 'at.exe',
        'wscript.exe', 'cscript.exe', 'mshta.exe', 'msbuild.exe', 'csc.exe',
        'installutil.exe', 'msxsl.exe', 'forfiles.exe', 'where.exe', 'whoami.exe',
        'systeminfo.exe', 'netstat.exe', 'tasklist.exe', 'taskkill.exe'
    }
