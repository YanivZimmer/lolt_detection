...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python main.py train --dataset dataset.jsonl
  python main.py evaluate --model-dir models
    ...
    train_parser.add_argument('--dataset', type=str, default='dataset.jsonl',
    ...
    eval_parser.add_argument('--dataset', type=str, default='dataset.jsonl',
                            help='Path to dataset file')
